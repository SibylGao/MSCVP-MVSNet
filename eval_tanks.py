...
def save_depth():
    # dataset, dataloader
    test_dataset = tanks_dtu_jiayu.MVSDataset(args, logger)
...
# read an image tanks数据集大小是1920*1080
...
def filter_depth(dataset_root, scan, out_folder, plyfilename):
    ...
    pair_file = dataset_root + scan + '/pair.txt'
    ...
    for ref_view, src_views in pair_data:
        ...
        ref_img = read_img( dataset_root + scan + '/images/{:08d}.jpg'.format(ref_view) ) # Image start from 1.
        ...
        for src_view in src_views:
            ...
            src_intrinsics, src_extrinsics = read_camera_parameters(
                dataset_root  + scan + '/cams/{:0>8}_cam.txt'.format(src_view) )
...
if __name__ == '__main__':
    ...
    # step2. fusion
    testlist = os.path.join(args.dataset_root,"scan_list.txt")
