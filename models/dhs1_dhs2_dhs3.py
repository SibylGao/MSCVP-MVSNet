...
#####################################################gao_added##########################################
        ...
        for level in range(self.args.nscale-2,-1,-1):    #是倒序金字塔
            ...
            if level==self.args.nscale-2:
                depth_hypos = calDepthHypo(self.args,depth_up,ref_in_multiscales[:,level,:,:], src_in_multiscales[:,:,level,:,:],ref_ex,src_ex,depth_min, depth_max,level,nhypothesis_init=32)
                ...
                gamma_s2 = -0.8425
                beta_s2 = -2.7181
                mindisparity_s3 = depth_up - (gamma_s2 + 1) * exp_variance - beta_s2
                maxdisparity_s3 = depth_up + (gamma_s2 + 1) * exp_variance + beta_s2
            ...
            confidence_save_path = "./depth_range_dhs1_dhs3_dhs2/"
