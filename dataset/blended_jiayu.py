...
def read_img_blended_stage3(filename):
    img = Image.open(filename)
    # scale 0~255 to 0~1
    img = np.array(img, dtype=np.float32) / 255.
    if img.shape[0] == 2048:
...
def read_cam_file_blended_stage3(filename):
